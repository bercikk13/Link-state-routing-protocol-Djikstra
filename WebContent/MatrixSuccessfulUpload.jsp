...
<html>
	<head> <%-- Head of the JSP --%>
		...
		<title>Matrix Successfully Uploaded</title> <%-- Title of the Web Page --%>
	...
	<body>
		...
		<main>
			...
			<table id="table" >
  				<tr>
    				<th><h1><i>Matrix Uploaded Successfully</i></h1></th>
  				</tr>
  				<tr>
  					<th>
  						
  						<%-- Creation of 2 forms, separate actions executed after either of the buttons are pressed--%>
    					<form action="ViewMatrixServlet" method="post">
    						<h2><i>
    							<input type="submit" value="Click here to View the Topography Matrix" >
							</i></h2>
    					</form>
					</th>
 				</tr>
