...
<html>
	...
	<body>
		...
		<main>
			...
			<table id="table" >
  				<tr>
    				<th><h1><i>Enter Source and Destination</i></h1></th>
  				</tr>
  				<tr>
  					<th>
  						
  						<%-- Creation of a form, the actions executed after an event--%>
    					<form action="dijkstrasServlet" method="post">
    						<h2><i>
    							
    							<%-- Creation of buttons--%>
    							
    							<label>Source Node</label>
    							<input type="text" name="Source_Node">
    							<br>
    							<label>Destination Node</label>   							    				
    							<input type="text" name="Destinaton_Node">
								<br><br>
