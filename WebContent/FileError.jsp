...
<html>
	<head> <%-- Head of the JSP --%>
		...
		<title>Error in The File</title> <%-- Title of the Web Page --%>
	...
	<body>
		...
		<main>
			...
			<table id="table" >
  				<tr>
    				<th><h1><i>!!!Error in the Input File!!!</i></h1></th>
  				</tr>
  				<tr>
    				<th><h1><i>Can be due to either because,</i></h1></th>
  				</tr>
  				<tr>
  					<th>
  						
  						<%-- Creation of a form, the actions executed after an event--%>
    					<form action="MatrixTopology.jsp" method="post">
    						<h2><i>
    							1) Or the matrix is not a square matrix
    							<br>
    							2) Or there is a cost associated from a node to itself(diagonal is not 0)
    							<br>
    							3) Or a non matrix format file has been uploaded
    							<br>
    							4) or You have Entered No File at all
    							<br><br><br>
