...
<html>
	...
	<body>
		...
		<main>
			...
			<table id="table" >
  				<tr>
    				<th><h1><i>Updated Connection Tables are as below:</i></h1></th>
  				</tr>
  				<tr>
  					<th>
  						<%
							...
							for(routers=1;routers<=row_Size;routers++)
							{
								...
								//Display the connection table after deleting the node
								for(int n=0; n<row_Size; n++)
									{
										...
										if(n==(routers-1))
										 ...
										 if(routers==(int)request.getServletContext().getAttribute("del_node") || read_matrix[routers-1][routers-1]==-1){
											 out.print("<h2>Router De-activated</h2>");
											 break;
										 }
										 
										 if(n!=(int)request.getServletContext().getAttribute("del_node")-1){
										 ...
										 if(n==(int)request.getServletContext().getAttribute("del_node")-1){
											 connect_tab[0][0]="Router "+(n+1)+"                  |                ";
											 connect_tab[0][1]= "De-activated"; 
										 }
										 if(read_matrix[n][n]==-1){
											 connect_tab[0][0]="Router "+(n+1)+"                  |                ";
											 connect_tab[0][1]= "De-activated"; 
										 }
