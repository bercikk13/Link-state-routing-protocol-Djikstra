...
<html>
	...
	<body>
		...
		<main>
			...
			<table id="table" >
  				<tr>
    				<th><h1><i>Choose your option below:</i></h1></th>
  				</tr>
  				<tr>
  					<th>
  						
  						<%-- Creation of a form, the actions executed after an event--%>
    					<form action="optionSelectServlet" method="post">
    						<h2><i>
    							
    							<%-- Creation of buttons--%>
    							<input type="radio" name="Option" value="Option_1">
    							<label for="Option1">Enter the Input Topology matrix</label><br>
    				
    							<input type="radio" name="Option" value="Option_4">
    							<label for="Option3">Primary Connection Tables</label><br>
    				
    							<input type="radio" name="Option" value="Option_5">
    							<label for="Option4">See the shortest path between the source and the destination</label><br>
    							
    							<input type="radio" name="Option" value="Option_3">
    							<label for="Option2">Remove Node</label><br>
    		
   								<input type="radio" name="Option" value="Option_6">
    							<label for="Option4">Exit</label><br><br><br><br>
