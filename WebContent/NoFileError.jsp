<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@page import="iit.djikstras.cn1.ViewMatrix"%>"
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<html>
	<head> <%-- Head of the JSP --%>
		<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
		
		<title>View Topology</title> <%-- Title of the Web Page --%>
	...
	<body>
		...
		<main>
			...
			<table id="table" >
  				<tr>
    				<th><h1><i>There is no Input File Found:</i></h1></th>
    			</tr>
    			<tr>
    				<th><h1><i>Try again from the beginning</i></h1></th>
  				</tr>
  				<tr>
  					<th>
