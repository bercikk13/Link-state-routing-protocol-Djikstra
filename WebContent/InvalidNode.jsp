...
<html>
	<head> <%-- Head of the JSP --%>
		...
		<title>Invalid Node</title> <%-- Title of the Web Page --%>
	...
	<body>
		...
		<main>
			...
			<table id="table" >
  				<tr>
    				<th><h1><i>!!!Error in the Entered Node!!!</i></h1></th>
  				</tr>
  				<tr>
    				<th><h1><i>Make Sure,</i></h1></th>
  				</tr>
  				<tr>
  					<th>
  						
  						<%-- Creation of a form, the actions executed after an event--%>
    					<form action="DeleteNode.jsp" method="post">
    						<h2><i>
    							1) The entered Source  node is valid(only numbers allowed)
    							<br>
    							
    							2) The entered Destination  node is valid(only numbers allowed)
    							<br><br><br>
