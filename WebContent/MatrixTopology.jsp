...
<html>
	<head> <%-- Head of the JSP --%>
		...
		<title>Input Matrix</title> <%-- Title of the Web Page --%>
		...
		<%-- upload button style of the webpage --%>
				input[type=file] {
					padding:5px 15px; 
	...
	<body>
		...
		<main>
			...
			<table id="table" >
  				<tr>
    				<th><h1><i>Browse for the file below:</i></h1></th>
  				</tr>
  				<tr>
  					<th>
  						
  						<%-- Creation of a form, the actions executed after selecting the desired File--%>
    					<form action="matrixUploadServlet" method="post" enctype="multipart/form-data">
    						<h2><i>
